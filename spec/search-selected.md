...
* When this badge is clicked, a request will be made to `/dictionaries/monier-williams/search?q={{ $g.Surface }}&tl=iast&mode=fuzzy&preview=true`, since preview is specified, the server will return a div fragment rather than full HTML page.
